  ...
  <main>
    ...
    <div class="buttons-container" v-if="!showCount">
      <template v-if="captured">
        <span class="button retake" role="button" @click="retake">Back</span>
        <span class="button save" role="button" @click="shareFile">Share</span>
      </template>
      <template v-else>
        <div class="slider">
          <span>zoom</span>
...
export default {
  ...
  computed: {
    filename () {
      return `gameboy/gameboy_${this.timestamp}.jpg`
    },
    palette () {
  ...
  methods: {
    ...
    async shareFile () {
      // const path = `gameboy/gameboy_${this.timestamp}.jpg`
